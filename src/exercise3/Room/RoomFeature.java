...
public enum RoomFeature {
    ...
    RoomFeature(String feature, int price) {
    ...
    public static List<RoomFeature> getRandomRoomFeatures(int numOfFeatures) {
        RoomFeature[] values = RoomFeature.values();
        int min = 0;
        ...
        return indices.subList(0, numOfFeatures).stream()
                .collect(ArrayList<RoomFeature>::new, (x, y) -> x.add(values[y]), ArrayList::addAll);
    }
